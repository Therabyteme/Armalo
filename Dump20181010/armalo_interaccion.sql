...
CREATE TABLE `interaccion` (
  ...
  `Pregunta` varchar(6000) DEFAULT NULL,
  KEY `Evento_idx` (`ID_EVENTO`),
  KEY `interact_idx` (`ID_EVENTO`),
  CONSTRAINT `interact` FOREIGN KEY (`ID_EVENTO`) REFERENCES `evento` (`id_event`)
...
-- Dump completed on 2018-10-10 18:50:34
